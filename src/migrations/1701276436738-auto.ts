...
export class Auto1701276436738 implements MigrationInterface {
    name = 'Auto1701276436738'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum_old" AS ENUM('order pending', 'order processing', 'order shipped', 'order completed', 'order cancelled')`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`);
