...
export class Auto1701269102929 implements MigrationInterface {
    name = 'Auto1701269102929'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "order_items" ("item_id" SERIAL NOT NULL, "quantity" integer NOT NULL, "buyingPrice" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "order_id" integer, "productId" integer, CONSTRAINT "PK_de591fd3dc04191ab115c03eab1" PRIMARY KEY ("item_id"))`);
        await queryRunner.query(`CREATE TABLE "orders" ("order_id" SERIAL NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'order pending', "total" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_cad55b3cb25b38be94d2ce831db" PRIMARY KEY ("order_id"))`);
